...
require 'includes/form_controller/register_controller.php';
require 'includes/form_controller/login_controller.php';
		...
		<div class="login_box">
			...
			<div id="first">
				<form action="register.php" method="POST">
					...
					<a href="admin_register.php" style="display: block; color: brown">Admin Login</a>
